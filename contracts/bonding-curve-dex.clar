...
(define-constant token-supply u99999997000000) ;; match with the token's supply (6 decimals)
...
(define-constant allow-token 'SPGNH14RQWAT05PVG8CEXCM7BGC5PPR01XVGQXPZ.pos-coin-stxcity)
...
(begin
  (var-set virtual-stx-amount VIRTUAL_STX_VALUE)
    ...
    (var-set token-balance u91008369770294)
    (var-set stx-balance u197600000)
