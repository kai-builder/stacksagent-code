...
(define-constant LAUNCHPAD_TOKEN 'SPSJK3N41CWJRTZJ6G554PFX6S9PYAS9SQJX0DKE.pump-eet)
...
(define-constant STXCITY_WALLET 'SP34YFJN83BJVNAMMBNZM44X8XVRJHBEZD4YGK3DE) ;; STXCITY wallet
(define-constant TOKEN_TO_LIST u499499999000) ;; parameter, user will replace it while creating presale
(define-constant TOKEN_TO_SELL u499499999000) ;; parameter,
(define-constant START_BLOCK u911023) ;; parameter, 
(define-constant END_BLOCK u913093) ;; parameter, 
(define-constant WHITELIST_END_BLOCK u911023) ;; parameter, End of whitelist period, start of public sale

;; Constants for STXCITY fee distribution
(define-constant STXCITY_FEE_PERCENT u5)  ;; 5% STXCITY fee
(define-constant DEPLOYER_PERCENT u45)   ;; Percentage of raise for deployer
...
(define-data-var presale-hardcap uint u10000000000)  ;; parameter
(define-data-var presale-softcap uint u100000000)  ;; parameter
(define-data-var min-buy uint u10000000)            ;; parameter
(define-data-var max-buy uint u5000000000)             ;; parameter
...
(begin
    ...
    (try! (contract-call? 'SPSJK3N41CWJRTZJ6G554PFX6S9PYAS9SQJX0DKE.pump-eet transfer u998999998000 tx-sender 'SPSJK3N41CWJRTZJ6G554PFX6S9PYAS9SQJX0DKE.presale-pumpeet-dbrm none))
    (var-set initialized true)
    
    ;; Transfer STX fee to stxcity wallet
    (try! (stx-transfer? u2000000 tx-sender 'SP1E5BJYT6PH3EKN1HCY2DF4Q3Q2V8FQ8NFW0W2BK))
