...
(define-constant LAUNCHPAD_TOKEN 'STB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W86MRSJT.new-decimals)
...
(define-constant TOKEN_TO_LIST u40000000000000000) ;; 100M 
(define-constant TOKEN_TO_SELL u40000000000000000)
(define-constant START_BLOCK u50651) ;; default 5 block from create
(define-constant END_BLOCK u60650)
(define-constant WHITELIST_END_BLOCK u60650) ;; End of whitelist period, start of public sale
...
(define-data-var presale-hardcap uint u200000000)  
  ...
  (let
    (
      ...
      (next-milestone-block 
        (if (< next-milestone-number (var-get ACTIVE_MILESTONE_COUNT))
          (unwrap-panic 
            (element-at 
    ...
    (ok {
      ...
      next-milestone: {
        ...
        additional-claimable: (if (< next-milestone-number u6)
                               (if (>= next-milestone-amount vested-amount)
...
(begin
    ...
    (try! (contract-call? 'STB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W86MRSJT.new-decimals transfer u800000000 00000000 tx-sender 'STB8PXKR86CKJNVG8Y3AQKFEZJX57NW2W86MRSJT.presale-newdecimals-2 none))
    (var-set initialized true)
    ;; Transfer STX Fee to stxcity
    (try! (stx-transfer? u200000 tx-sender 'ST351YPXNR61E8137E5VNBW31AZQ88MB2DMNXFFF6))
