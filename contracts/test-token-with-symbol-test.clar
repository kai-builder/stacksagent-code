;; TEST Token with symbol TEST - SIP-010 Fungible Token
...
;; Token definitions
(define-fungible-token TEST u1000000)

;; Initialize token supply to contract owner
(begin
  (try! (ft-mint? TEST u1000000 contract-owner))
)
...
(define-read-only (get-name)
  (ok "TEST Token with symbol TEST"))
